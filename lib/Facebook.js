...
function Facebookbot(configuration) {
    ...
    facebook_botkit.createWebhookEndpoints = function(webserver, bot, cb) {
        ...
        facebook_botkit.log(
            ...
            'http://' + facebook_botkit.config.hostname + ':' + facebook_botkit.config.port + '/facebook/receive/:from');
        webserver.post('/facebook/receive/:from', function(req, res) {
            res.send('ok');
            facebook_botkit.handleWebhookPayload(req, res, bot);
        });

        webserver.get('/facebook/receive/:from', function(req, res) {
